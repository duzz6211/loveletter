...
export const WALLS = [
  ...
  {
    kind: "text",
    question: "남자친구가 당신을 부르는 별명은?",
    copy: "그 사람만 부르는 이름이 하나 있어요.",
    accept: ["유냉"],
    placeholder: "별명을 적어주세요",
    success: "맞아요. 그렇게 부를 때마다 웃었죠.",
  },
  {
    kind: "text",
    question: "내가 너에게 반한 날은?",
    copy: "날짜가 아니라, 그 날을 부르는 이름으로 적어주세요.",
    /* 공백은 무시하고 비교하므로 "처음 본 날" 과 "처음본날" 은 같은 대답이다.
       아래 목록은 어디까지 받아줄 생각인지를 적어 둔 것이다. */
    accept: [
      "처음 본 날", "처음본날", "첫만남", "첫인상", "첫 데이트", "첫데이트",
    ],
    placeholder: "그 날을 적어주세요",
    success: "그 날부터였어요. 아홉 번째 봉인이 풀립니다.",
  },
  {
    kind: "choice",
